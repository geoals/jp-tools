...
//! one more read-stats route, which is what every other thing the popup asks
//! for already is.
...
/// hand the page a read-stats URL for.
...
/// host or a parent directory would make read-stats fetch whatever it was
